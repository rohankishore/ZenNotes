...
class CustomTitleBar(MSFluentTitleBar):
    ...
    def __init__(self, parent):
        ...
        saveall_action = Action(text="Save All", icon=FIF.SAVE)
        saveall_action.setShortcut("Ctrl+Alt+S")
        saveall_shortcut = QShortcut(QKeySequence("Ctrl+Alt+S"), self)
        saveall_action.triggered.connect(parent.save_all_documents)
        saveall_shortcut.activated.connect(parent.save_all_documents)
