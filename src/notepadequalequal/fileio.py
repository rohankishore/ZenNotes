...
def write_settings(event=None, tab_mode=None, language_mode=None, autosave_enabled=None, default_encoding=None):
    common.setup_prefs()
    ...
    default_encoding = default_encoding.get()
    with open(settings_path, 'w', encoding='utf-8') as file:
        ...
        file.write(f"default_encoding = '{default_encoding}'\n")
...
def read_settings(event=None):
    ...
    return returned_settings["tab_mode"], returned_settings["language_mode"], returned_settings["autosave_enabled"], returned_settings.get("default_encoding", "utf-8")
